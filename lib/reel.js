...
exports.createReel = function (cmds) {
...
exports.startReel = function (id) {

   // execute job from id and give back status, elapsed time, reel id, need to pass optional timeout
   console.log('starting reel: ' + id);
   var reeler = new Reeler(this.settings);
   //console.log(reeler);
   var result = reeler.start(id);
   return result;
};

exports.cancelReel = function (id) {
