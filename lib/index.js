...
exports.register = function (server, options, next) {
    ...
    server.expose('getRunByName', utils.getRunByName);
    ...
    server.expose('runCommand', utils.runCommand);
    ...
    server.route([
        ...
        {
            method: 'GET',
            path: settings.apiPath+'/run/byname/{name}',
            config: {
                handler: Api.getRunByName,
                description: "get run byname",
                validate: {
                    params: {
        ...
        {
            method: 'POST',
            path: settings.apiPath+'/run/command',
            config: {
                handler: Api.runCommand,
