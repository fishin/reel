...
module.exports.getRunByName = function (request, reply) {

   var utils = new Utils(this.settings);
   var result = utils.getRunByName(request.params.name);
   reply(result);
};
...
module.exports.runCommand = function (request, reply) {

   var utils = new Utils(this.settings);
   utils.runCommand(request.payload.command, function(result) {
...
module.exports.deleteWorkspace = function (request, reply) {

   var utils = new Utils(this.settings);
   var result = utils.deleteWorkspace();
   reply(result);
};
