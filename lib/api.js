...
module.exports.startRun = function (request, reply) {
   ...
   var utils = new Utils(this.settings);
   var result = utils.startRun(request.params.id);
   reply(result);
};
...
module.exports.cancelRun = function (request, reply) {
   ...
   var utils = new Utils(this.settings);
   var result = utils.cancelRun(request.params.id);
   reply(result);
};
...
module.exports.getRun = function (request, reply) {
   ...
   var utils = new Utils(this.settings);
   var result = utils.getRun(request.params.id);
   reply(result);
};
...
module.exports.deleteRun = function (request, reply) {
   ...
   var utils = new Utils(this.settings);
   var result = utils.deleteRun(request.params.id);
   reply(result);
};
