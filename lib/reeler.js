...
internals.executeSync = function(cmd) {
    ...
    if (typeof cmd === 'object') {
       ...
       for (var i = 0; i < cmds.length; i++) {
          ...
          result.pid.push(subResult.pid);
          result.signal.push(subResult.signal);
          if (subResult.stderr) {
       ...
       // err =  executer.error;
       //}
       result.pid.push(executer.pid);
       result.signal.push(executer.signal);
       if (executer.err) {
