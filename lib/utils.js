...
exports.createRun = function (cmds, dirpath) {
   ...
   var pail;
   if (dirpath) {
      var newSettings = internals.Utils.settings.reel;
      newSettings.reel.dirpath = dirpath;
      pail = new Pail(newSettings);
   } else {
      pail = new Pail(internals.Utils.settings.reel);
   }
...
exports.startRun = function (runId, dirpath) {
   ...
   //console.log(reeler);
   var result = runner.start(runId, dirpath);
   return result;
};
