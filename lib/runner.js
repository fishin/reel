...
exports.getPids = function(run_id) {

    //console.log('getting pids for: ' + run_id);
    var runIndex = internals.getRunIndex(run_id);
...
internals.getRunIndex = function(run_id) {
...
internals.serialCall = function (run_id, commands, ready) {
    ...
    internals.activeRuns.push({ run_id: run_id, pids: []});
    var results = [];
    var pail = new Pail(internals.Runner.settings.reel);
    ...
    function iterate() {
        ...
        var error;
        var runIndex = internals.getRunIndex(run_id);
        //console.log('adding pid for run: ' + run_id);
